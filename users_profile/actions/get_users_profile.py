...
class GetUsersProfile(BaseActionsRead):
    def __init__(self, validated_data):
        ...
        #                                                         self.keypair.private_key.hex())
        self.user_merchant_profile = update_or_created_get_user_merchant_profile(self.account_id.mate_data_address(),
                                                                            self.keypair.private_key.hex())
        # self.results = dict()
    ...
    def serializers(self):
        return UserMerchantProfileSerializer(self.user_merchant_profile).data
        # return self.results
